...
class MoviePersonality(ans.Answer):
    ...
    @classmethod
    def metaData(cls):
        return {citation:'Based on <a href="http://www.sciencedirect.com/science/article/pii/S0092656603000461">\'A very brief measure of the Big-Five personality domains\' Gosling, Rentfrow, and Swann (2003)</a>.'}
